...
<div class="container">
    ...
    <div class="container__about about container__fixed container__fixed_adaptive" style="min-height: 1000px">
        <div class="container__heading">Политика безопасности</div>
        <div class="container__text">ПОЛЬЗОВАТЕЛЬСКОЕ СОГЛАШЕНИЕ

            г. Тирасполь                                                       «23» Сентября 2018г.



            1. ОБЩИЕ ПОЛОЖЕНИЯ

            1.1.   Настоящее Пользовательское соглашение (далее – Соглашение) относится к сайту Интернет-магазина «Love Sushi&Pizza», расположенному

            по адресу love-sushi.org, и ко всем соответствующим сайтам, связанным с сайтом www.love-sushi.org.

            1.2.   Сайт Интернет-магазина « Love Sushi&Pizza»  (далее – Сайт) является собственностью ИП Балицкого В.А.

            1.3.   Настоящее Соглашение регулирует отношения между Администрацией сайта Интернет-магазина «Love Sushi&Pizza»  (далее – Администрация сайта) и Пользователем данного Сайта.
            ...
            2.1.1 «Love Sushi&Pizza» – Интернет-магазин, расположенный на доменном имени www.love-sushi.org, осуществляющий свою деятельность посредством Интернет-ресурса и сопутствующих ему сервисов.
            ...
            2.1.3. Администрация сайта Интернет-магазина – уполномоченные сотрудники на управления Сайтом, действующие от имени ИП Баликого В.А.
            ...
            4.2.3. Задавать любые вопросы, относящиеся к услугам Интернет-магазина по реквизитам, которые находятся в разделе Сайта «Форму связи».
            ...
            5.7. Администрация сайта обладает правом в одностороннем порядке аннулировать учетную запись Пользователя, если она не использовалась более 12 календарных месяцев подряд без уведомления Пользователя.
            ...
            7.2. Администрация сайта имеет право раскрыть любую информацию о Пользователе, которую посчитает необходимой для выполнения положений действующего законодательства или судебных решений, обеспечения выполнения условий настоящего Соглашения, защиты прав или безопасности Love Sushi&Pizza, Пользователей.
            ...
            Обновлено «23» Сентября 2018 г.</div>
    </div>
